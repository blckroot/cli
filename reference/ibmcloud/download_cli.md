...
If you need to use a 32-bit version, or a previous version other than the latest for {{site.data.keyword.cloud_notm}} Dedicated environments, see [{{site.data.keyword.cloud_notm}} CLI releases](https://github.com/blckswan-ungtb10d/ibm-cloud-cli-release/releases/){: external}.
...
1. Use a browser to access the official [`ibm-cloud-cli-releases`](https://github.com/blckswan-ungtb10d/ibm-cloud-cli-release/releases/) GitHub repository, and **select** the installer of your OS to begin the download. The following operating systems are supported: macOS X 64-bit, Windows&trade; 64-bit, Linux&trade; x86 64-bit, and Linux&trade; LE 64-bit (ppc64le).
...
1. Use a browser to access the official [`ibm-cloud-cli-releases`](https://github.com/blckswan-ungtb10d/ibm-cloud-cli-release/releases/) GitHub repository, and **select** the matching binary of your platform to begin the download. The following platforms are supported: macOS, linux32, linux64, ppc64le, win32, and win64.
...
To get notified about new {{site.data.keyword.cloud_notm}} CLI releases, subscribe to the [{{site.data.keyword.cloud_notm}} CLI releases repository](https://github.com/blckswan-ungtb10d/ibm-cloud-cli-release/releases/){: external}.
